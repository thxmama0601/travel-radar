...
export default function Dashboard({endpoint="/api/news", snapshotMode=false}:{endpoint?:string;snapshotMode?:boolean}) {
  ...
  return <div className="app-shell">
    <aside className="sidebar"><a href="./" className="brand"><span className="brand-icon"><Radar size={25}/></span><span>CC三寶媽-<wbr/>旅遊雷達<small>TRAVEL RADAR</small></span></a><div className="nav-caption">探索消息</div>
