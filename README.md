...
共 16 個來源頻道，包括 5 個品牌優惠查詢、5 個指定媒體／官方來源與 6 個地區查詢。

品牌優惠透過 Google 新聞索引搜尋，並非各平台的官方 RSS、完整促銷目錄或即時房價 API；保留原媒體名稱。ETtoday 與 JNTO 直接讀官方 RSS；JNTO 公告為日文，包含統計、活動及招募，並非日本觀光廳或國稅廳的政策 RSS。天下舊 RSS 在 2026/09/23 驗證時最新文章為 2021/09/29，因此另以搜尋索引補充近期標題。
